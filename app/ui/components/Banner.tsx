    ...
    return(
        <div className=" bg-cover bg-center h-screen w-full flex flex-col  justify-center  text-center" style={{backgroundImage:`url('/images/water.jpg')`}} >
            <div className="mb-5 w-full" >
                ...
                <button className="bg-green-400 text-white rounded-full px-5 py-3 hover:bg-green-600 transition ease-in-out duration-300"><Link href={"#Locations"}>Explore More</Link></button>
            </div>
        </div>
    )
}